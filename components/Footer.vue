<template>
    <footer class="font-medium text-dark-green mx-5">
        <div class="flex flex-col space-x-0 md:space-x-[10%] md:flex-row md:justify-center">
            <div class="flex flex-col pt-10 border-t border-green/40 mb-10 items-start">
                ...
                <div class="flex flex-row">
                    <a href="https://www.instagram.com/pinewaygolfco/" class="mr-6" target="_blank">
                    ...
                    <a href="https://www.facebook.com/Pineway-Golf-Co-112831114240402" target="_blank">
                        <svg class="fill-red hover:fill-green" width="27" height="27" viewBox="0 0 27 27" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="grid grid-flow-row gap-4 pt-10 mb-10 border-t border-green/40">
                <h2 class="sr-only">Hours</h2>
                <div v-for="days in homeData.hours" v-bind:key="days.id" class="grid grid-flow-col grid-cols-[2fr_1fr]">
                    <p>{{days.days}}</p>
                    <p>{{days.times}}</p>
                </div>
                <p class="col-span-2 text-sm font-regular">Hours subject to change.<br>
                Last call for ball rental 30 minutes before close.</p>
            </div>
        ...
        <div class="text-center mt-10 flex flex-col items-center">
            <img src="../assets/images/logo.svg" class="mb-8 h-14">
            <p>© Pineway Golf Co</p>
            <img src="../assets/images/footer-golfer.png" class="h-36 mt-12">
        </div>
    </footer>
</template>
